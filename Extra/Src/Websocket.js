...
//                             const FastConfig_Path = require(process.cwd() + "/Abdulla_Database/FastConfigFca.json");
...
//                                     }
//                                     global.Fca.Require.fs.writeFileSync(process.cwd() + "/Abdulla_Database/FastConfigFca.json", JSON.stringify(FastConfig_Path, null, "\t"));
...
//                                 }
//                                 catch (e) {
//                                     global.Fca.Require.fs.writeFileSync(process.cwd() + "/Abdulla_Database/FastConfigFca.json", JSON.stringify(FastConfig_Global, null, "\t"));
